      ...
      <div className="relative z-10 w-full h-full overflow-y-auto overflow-x-hidden flex flex-col items-center justify-start pt-[15vh] md:justify-center md:pt-0">
        ...
        <form onSubmit={handleSubmit} className="absolute inset-0 w-full h-full">
          ...
          <button
            type="submit"
            disabled={loading}
            className="absolute top-[77%] left-[43.5%] w-[16%] h-[9%] bg-red-500/40 border-2 border-red-500 hover:bg-red-500/60 active:bg-red-500/80 rounded-full cursor-pointer transition-colors focus:outline-none flex items-center justify-center disabled:opacity-50"
